...
@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/pages/add']")WebElement newListPageClick;
@FindBy(xpath="//input[@id='title']")WebElement productTitle;
@FindBy(xpath="//div[@class='note-editable card-block']")WebElement productDescription;
@FindBy(xpath="//input[@id='page']")WebElement enterPageName;
@FindBy(xpath="//input[@id='main_img']")WebElement productImageUpload;
@FindBy(xpath="//button[@type='submit']")WebElement saveProductDetail;
